...
function RoomResult({ roomSearchResults, viewMode = 'grid' }) {
                    ...
                    {roomSearchResults.map((room, index) => (
                        ...
                        >
                            ...
                            <div className={`relative overflow-hidden ${
                                viewMode === 'list' ? 'md:w-1/3 md:flex-shrink-0' : ''
                            }`}>
                                <img 
                            ...
                            {/* Content */}
                            <div className={`p-6 ${
                                viewMode === 'list' ? 'md:flex-1 md:flex md:flex-col md:justify-between' : ''
                            }`}>
                                <div>
                                    {/* Room Type & Rating */}
                                    <div className={`flex justify-between items-start mb-3 ${
                                        viewMode === 'list' ? 'md:flex-wrap' : ''
                                    }`}>
